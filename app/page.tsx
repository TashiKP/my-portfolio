...
export default function Home() {
  ...
  return (
    <>
      <div className="relative min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 overflow-hidden flex items-center justify-center p-6">
        {/* Background Mesh */}
        ...
        <div className="relative z-10">
          <div className="absolute inset-0 bg-gradient-to-r from-purple-600 via-pink-600 to-cyan-600 rounded-3xl blur-xl opacity-75 animate-pulse"></div>
          <div className="relative bg-gradient-to-br from-white/10 to-white/5 backdrop-blur-2xl rounded-3xl p-1 shadow-2xl border border-white/20">
            <div
              ref={cardRef}
              className="bg-gradient-to-br from-slate-900/90 to-slate-800/90 backdrop-blur-xl rounded-3xl p-12 w-full max-w-lg text-center relative overflow-hidden"
            >
              {/* Profile */}
              <div className="relative z-10 mb-8">
                <div className="relative inline-block">
                  ...
                  <div className="relative w-36 h-36 mx-auto rounded-full overflow-hidden border-4 border-white/30 shadow-2xl">
                    <Image
                      src="/profile.jpeg"
                      alt="Profile picture"
              ...
              {/* Name */}
              <div className="relative z-10 mb-8">
                <h1 className="text-4xl font-bold mb-3 bg-gradient-to-r from-white via-purple-200 to-cyan-200 bg-clip-text text-transparent">
                  Tashi Kuenga Phuntsho
                </h1>
                <div className="w-16 h-1 bg-gradient-to-r from-purple-500 to-cyan-500 mx-auto mb-4 rounded-full"></div>
              ...
              {/* Quote */}
              <div className="relative z-10 mb-8">
                <div className="bg-gradient-to-r from-purple-500/20 to-cyan-500/20 rounded-2xl p-6 border border-white/10 backdrop-blur-sm">
              ...
              <div className="relative z-10">
                <button
                  ...
                  className="group relative px-8 py-4 bg-gradient-to-r from-purple-600 to-cyan-600 rounded-full font-semibold text-white shadow-lg hover:shadow-2xl transform transition-all duration-300 hover:scale-105 hover:from-purple-500 hover:to-cyan-500"
                >
              ...
              {/* Decorative dots */}
              <div className="absolute top-6 right-6 w-2 h-2 bg-purple-400 rounded-full animate-ping"></div>
              <div className="absolute bottom-6 left-6 w-2 h-2 bg-cyan-400 rounded-full animate-ping animation-delay-1000"></div>
              <div className="absolute top-1/2 left-4 w-1 h-1 bg-white rounded-full animate-pulse"></div>
              <div className="absolute top-1/3 right-4 w-1 h-1 bg-white rounded-full animate-pulse animation-delay-2000"></div>
            </div>
          </div>
        </div>
        ...
        <div className="fixed bottom-6 right-6 z-50">
          ...
          <div className={`mb-3 transition-all duration-500 ease-out ${
            ...
            <div className="bg-gradient-to-br from-slate-900/95 to-slate-800/95 backdrop-blur-2xl border border-white/20 rounded-2xl p-5 shadow-2xl shadow-purple-500/10 min-w-[260px]">
              {/* Profile Section */}
              <div className="flex items-center gap-3 mb-4">
                ...
                <div>
                  <h3 className="text-sm font-semibold text-white">Tashi Kuenga</h3>
              ...
              <div className="space-y-2">
                <button
                  ...
                  className="w-full flex items-center gap-3 px-3 py-2 bg-gradient-to-r from-purple-600/20 to-pink-600/20 hover:from-purple-600/30 hover:to-pink-600/30 rounded-lg border border-white/10 hover:border-white/20 transition-all duration-300 group"
                >
                  <svg className="w-4 h-4 text-purple-300 group-hover:text-white transition-colors" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                <a
                  ...
                  className="w-full flex items-center gap-3 px-3 py-2 bg-gradient-to-r from-pink-600/20 to-purple-600/20 hover:from-pink-600/30 hover:to-purple-600/30 rounded-lg border border-white/10 hover:border-white/20 transition-all duration-300 group"
                >
                  <svg className="w-4 h-4 text-pink-300 group-hover:text-white transition-colors" fill="currentColor" viewBox="0 0 24 24">
          ...
          <button
            ...
            className="group relative w-14 h-14 bg-gradient-to-r from-purple-600 to-cyan-600 hover:from-purple-500 hover:to-cyan-500 rounded-full shadow-lg hover:shadow-2xl hover:shadow-purple-500/25 transition-all duration-300 hover:scale-110 flex items-center justify-center"
          >
...
function FloatingIcon({ src, cardBounds, index, total }: FloatingIconProps) {
  ...
  const direction = useRef({
    dx: Math.random() * 0.005 - 0.025,
    dy: Math.random() * 0.005 - 0.025,
  });
  ...
  return (
    <Image
      ...
      width={size}
      height={size}
      className="absolute opacity-25 drop-shadow-2xl brightness-110 pointer-events-none hover:opacity-40 transition-opacity duration-300"
      style={{
